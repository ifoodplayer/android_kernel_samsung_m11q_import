				   ...
				   enum wcd_mbhc_plug_type plug_type)
{
	...
	if (plug_type == MBHC_PLUG_TYPE_HEADPHONE) {
		...
		/* HS60 add HS60-148 compatible headset button by xudayi at 2019/08/23 start */
		wcd_mbhc_report_plug(mbhc, 1, SND_JACK_HEADSET);
		/* HS60 add HS60-148 compatible headset button by xudayi at 2019/08/23 end */
