...
#define SMARTAMP_SPEAKER_CALIBDATA_FILE "/persist/audio/ti/tas25xx_calib.bin"
...
#ifdef ENABLE_SYS_NODE_CALIB
void tas_smartamp_add_sys_node_calib(struct i2c_client *pclient);
void tas_smartamp_remove_sys_node_calib(struct i2c_client *pClient);
#endif
